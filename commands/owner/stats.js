...
//command
  if(message.author.id != 495265351270137883){
    const noperms = new MessageEmbed()
    .setDescription("<:astroz_wrong:825598313499459605> This Command Only Use By My Owner **Sabry** ")
    .setColor("YELLOW");
...
.setTitle(`**[Support Server]**`)
  ...
  .addFields(
    ...
    { name: "<a:Owner:822760998938869760> Bot Owner:",value: `\`\`\`Sabry\`\`\``},
  )
  .setColor("3498DB")
